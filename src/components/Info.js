...
const UserInfo = () => {
  ...
  const items =[
     {id: 1, icon:<GoRepo className='icon' />, label: 'repos', value:public_repos, color:'pink'}, // anlamadim
...
// 25 <Item key={item.id} {...item}>  neden id'yi ayrica yazdirdi hepsini {...item} diye yazdirmadi